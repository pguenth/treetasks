...
\fi
    ...
    \keyd           T{},t{open new tab (in dev)}
    \keyd           Y{},y{copy cursor}
    \keyd          U{redo (currently in dev)},u{undo (currently in dev)}
...
\fi
    ...
    \keyd           S{save},s{sort\note{3}}
    \keyd          D{},d{cut\note{2}}
    \keyd          F{toggle show done},f{toggle done}
    \keyd           G{toggle show cancelled},g{toggle cancelled}
    ...
    \keyd           V{toggle sort tagged below},v{toggle collapse}
    \keyd          B{move selected task up},b{move selected task down}
